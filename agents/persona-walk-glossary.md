...
- glossary contract schema: `.claude-plugin/design-system/generator/contract/folio-glossary.glossary.yaml` (instance#1 folio self-host = 単一 domain 33 語) / `contract/clinic-appointment.glossary.yaml` (multi-domain 実例 = 予約業務 / 実現方式 / 確かめ方 25 語)
