...
case "$rc" in
  ...
  *) folio_deny \
       ...
       "  index: ${readme}" \
       "  reference: design-intent/spec/README.html §2 (cluster index)" ;;
esac
...
folio_deny \
  ...
  "  reference: design-intent/spec/README.html §2 (cluster index), design-intent/spec/relations.html §4 (inventory)"
