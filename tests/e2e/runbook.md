...
- walk 前後で sandbox 50/50 PASS を維持 (`rm -f .folio/architect-active` 後に runner 実行、18 scenario file)。
...
- [ ] sandbox 50/50 PASS を維持した (18 scenario file、marker cleanup 後に runner 実行)
