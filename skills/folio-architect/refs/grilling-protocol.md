...
- **概念が出たら** → canonical name を提案し (P-5)、`vocabulary.yaml` に persist する。
...
- rules.html §6 (EARS) / §10.3 (ADR Worthiness、Slice 2 で新設予定) / §5 (delta marker)
- ADR-0031 (mattpocock authoring 吸収: §2.2 grilling / §2.3 adoption-aware + lazy init)
- `vocabulary.yaml` (P-5 canonical name SSoT、Slice 2 で enrich 予定)
